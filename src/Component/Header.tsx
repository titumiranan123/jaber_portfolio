...
const Header: React.FC<props> = ({ sectionRefs }: any) => {
  return (
    <div className="header_bg   w-full  relative ">
      ...
      <div className="max-w-[1240px] lg:h-screen h-[720px]    flex justify-center items-center flex-col mx-auto  lg:px-0 px-4">
        <div className="flex justify-center items-center flex-col">
          ...
          <div className="relative mt-[6px] ">
            ...
            <div className="relative">
              <img
                className={`lg:w-full lg:h-[520px]  mt-[216px]  w-full h-[502px]  lg:mt-[250px] transition-transform duration-700  z-30`}
                src={user}
                alt="jaber"
                loading="lazy"
              />
              <button className="bg-[#1A2C38D1] absolute lg:bottom-28 bottom-24 lg:left-44 left-[106px] text-white lg:py-3 lg:px-6 py-2 px-4 rounded-[12px] flex gap-4">
